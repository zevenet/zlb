...
$zlibdir = "/usr/share/perl5/Zevenet";
...
# FarmGuardian command, checks backend servers
$farmguardian = "/usr/local/zevenet/bin/farmguardian";
# Where is l4sd?
$l4sd = "/usr/local/zevenet/bin/l4sd";
...
$confhttp = "/usr/local/zevenet/app/cherokee/etc/cherokee/cherokee.conf";
...
$fwmarksconf = "/usr/local/zevenet/config/fwmarks.conf";
...
$poundtpl = "/usr/local/zevenet/share/pound.cfg.template";
# Cipher PCI
...
$rrdap_dir = "/usr/local/zevenet/app/zenrrd";
...
# Do backup to
$backupfor = "/usr/local/zevenet/config /usr/local/zevenet/www/*.pem /usr/local/zevenet/app/cherokee/etc/cherokee/cherokee.conf /etc/iproute2/rt_tables /etc/ssh/sshd_config /etc/snmp/snmpd.conf /etc/hostname /etc/resolv.conf /etc/cron.d/zevenet /zevenet_version";
